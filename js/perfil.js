...
<p class="center">Clique no botão abaixo para ver/editar seu perfil no Google.</p>
...
<button class="btnLogout" type="button" onclick="fbSignOut('index.html')"><i class="fa-solid fa-right-from-bracket fa-fw"></i> Logout / Sair</button>
